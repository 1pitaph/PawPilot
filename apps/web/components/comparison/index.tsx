...
const comparisonData: ComparisonData[] = [
  {
    title: "Approach",
    zhaobian: "Design and engineering in sync",
    traditional: "Disconnected teams",
    icon: <DimondIcon />,
  },
  {
    title: "Process",
    zhaobian: "Streamlined, transparent, and async",
    traditional: "Endless calls, vague timelines",
    icon: <ChipIcon />,
  },
  {
    title: "Design Philosophy",
    zhaobian: "Modern, minimal, and purposeful.",
    traditional: "Trend-based and cluttered",
    icon: <NodeLines />,
  },
  {
    title: "Development Stack",
    zhaobian: "Built with modern frameworks",
    traditional: "Outdated stacks",
    icon: <CubeIcon />,
  },
  {
    title: "Communication",
    zhaobian: "Clear updates",
    traditional: "Multiple middlemen",
    icon: <MessageIcon />,
  },
  {
    title: "Deliverables",
    zhaobian: "Production-ready design systems",
    traditional: "Static mockups",
    icon: <MessageSend />,
  },
  {
    title: "Support",
    zhaobian: "Long-term partnership mindset",
    ...
    <section className="w-full">
      <Container className="flex flex-col gap-15 py-20 md:py-30">
        <div className="flex flex-col gap-6">
          <Header>爪边 VS Traditional Service Providers</Header>
